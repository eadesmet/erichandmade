...
inline void
RenderProjectile(render_buffer* Render, screen_map *Map, projectile* Projectile)
{
    real32 ProjectileSize = 10;
    v3 ProjectileColor = V3(1.0f, 1.0f, 0.0f);
    if (Projectile->IsActive)
    {
        v2 P1 = GamePointToScreenPoint(Projectile->P1);
        v2 P2 = GamePointToScreenPoint(Projectile->P2);
